...
\end{aligned}
$$
\bg{This is, when the linear effect is not selected, the probability of including the nonlinear effect drops from $\theta_j$ to 0. For computational convenience, we analytically integrate $\gamma_j$ out such that $\gamma_{j}^\tp | \theta_j \sim Bin(1, \theta_j^2)$ (see the derivation in the Supporting Information).
}
