...
rbind(
  ...
  xtable(
    caption = "Prediction performance of optimal BHAM and SB-GAM models for Emory Cardiovascular Biobank by 10-fold cross-validation, including deviance, area under the curve (AUC), Brier score, and misclassification error (Misclass) where class labels are defined using threshold = 0.5.",
    label = "tab:ECB_res"
  ) %>% 
...
rbind(
  ...
  rename(
    ...
    xtable(
    caption = "Prediction performance of of optimal BHAM and SB-GAM models for Weight Loss Maintenance Cohort by 10-fold cross-validation, including deviance, $R^2$,  mean squared error (MSE), and mean absolute error (MAE).",
    label = "tab:WLM_res"
  ) %>%
