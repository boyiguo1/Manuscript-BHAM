...
1 & 4.00 & 0.90 (0.01) & 0.90 (0.01) & 0.73 (0.09) & 0.71 (0.13) & 0.90 (0.01) & 0.82 (0.04) \\ 
  ...
  4 & 200.00 & 0.73 (0.10) & 0.60 (0.08) & 0.39 (0.17) & 0.45 (0.19) & NaN (NA) & 0.81 (0.05) \\ 
   \hline
\end{tabular}
\caption{The average and standard deviation of the out-of-sample area under the curve measure over for binomial outcome over 50 iterations} 
\label{tab:gaus}
\end{table}
...
To evaluate the predictive performance of the models, \(R^2\) for
Gaussian model, area under the curve (AUC) are calculated for binomial
model, averaging across 50 simulations. The results are tabulated in
Table \ref{tab:gaus}, \ref{tab:bin_auc}.\footnote{is it better to
  provide a box plot or a table.}
