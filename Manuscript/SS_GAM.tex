...
derivative of the spline function, expressed mathematically as \[
  \text{pen}f_j(x) = \lambda_j \int f^{"}_j(x)dx = \lambda_j \boldsymbol{\beta}_j^T \boldsymbol{S}_j \boldsymbol{\beta}_j,
\] where \(\boldsymbol{S}_j\) is a known penalty matrix, and
